...
export default{
    ...
    //    var foreach1=[]
        this.axios
            ...
            //     if(n.receive.Name==this.messageName.Name){
            //               foreach1.push(n)
            //     }
            //   })
            //   console.log('foreach1',foreach1);
            //   console.log(this.messageName.Name);
...
{
        this.axios
            .post('http://localhost:3000/private',{
