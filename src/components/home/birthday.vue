<template>
    <v-container class="main" :fluid=side>
        ...
        <v-text-field v-model="search" type="search" :label="this.$t('search')" prepend-inner-icon="mdi-magnify">
        </v-text-field>
        <!-- <v-divider  :thickness="20" color="white"></v-divider> -->
        <v-card>
            <v-data-table-virtual :items="birthday" height="600" :search="search">
